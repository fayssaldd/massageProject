...
export default function Home() {
  ...
  return (
    <>
      ...
      className={`grid lg:grid-cols-4 md:grid-cols-2 items-center  bg-cover lg:gap-8 gap-4 h-screen max-sm:h-[85vh] p-3`}>

        <div className="max-md:order-1 max-sm:mt-9 items-center flex flex-col justify-center lg:col-span-2 md:h-screen w-full md:rounded-br-xl lg:p-12">
          <div dir='rtl' className="text-6xl pb-8 font-semibold inline-flex italic items-center text-black dark:text-white ">
            <span className=" border-b-4 border-[#10c3da] font-mono italic ">
            مساج 
            </span>{" "}
            <span className="[text-shadow:_0_4px_8px_#00BCD4] text-[#00BCD4] ms-2 font-mono italic border-b-4 border-black dark:border-white">
              {" "}
              منزلي
            </span>
